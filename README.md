...
<table align="center">
  <tr>
    <td align="center" width="50%">
      ...
      <br>
      <b>(a)</b> Difference in climate cost, \(C(w_t,G_t)-C_{FB}(G_t)\)
    </td>
    <td align="center" width="50%">
      <img src="figures_sb/sb2_GHG_stock_diff.png" width="100%">
      <br>
      <b>(b)</b> Difference in GHG stock, \(G_{SB,t}-G_{FB,t}\)
    </td>
  </tr>
...
<br>
<p align="center">
  <b>Figure 2.</b> Comparison of dynamics under the first-best and the second-best (SB) contract for
